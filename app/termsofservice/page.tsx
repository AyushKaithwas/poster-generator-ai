export default function TermsOfService() {
  return (
    <div className="flex flex-col gap-10 justify-center min-h-[80vh] p-10">
      <h1 className="font-semibold text-3xl">Terms of Service</h1>
      <main className="flex flex-col gap-3 md:w-[70rem]">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to AI Poster Generator, accessible
              from{" "}
        ...
        <h2>Refund Policy</h2>
        <p>
          By using this site and buying credits, you agree to our refund policy
          and will not seek to ask for refunds if you are unhappy with the
          results of your AI generated posters. You understand the limitations
          of AI art. Some of these limitations include an inability to generate
          letters and characters, often misintreprts prompts, often might have
          deformed results, etc. When buying credits, you accept the risk that
          some AI generated posters may not be perfect.
        </p>
        ...
        <p>
          We can use your posters to promote our service. This includes, but is
        ...
        <p>
          Our service uses AI provided by OpenAI to generate posters. Please
